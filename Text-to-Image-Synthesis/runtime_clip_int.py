from trainer_clip_int import Trainer
import argparse
...
parser.add_argument("--int_coef", default=0.5, type=float)
...
parser.add_argument('--config_path', default='config_clip.yaml', type=str)
parser.add_argument('--checkpoints_path', default='checkpoints_clip', type=str)
